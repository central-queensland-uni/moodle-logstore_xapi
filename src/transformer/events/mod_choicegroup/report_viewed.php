...
/**
 * xAPI transformer for mod_choicegroup course module viewed event.
 *
...
function course_module_viewed(array $config, \stdClass $event) {
    ...
    return [[
        ...
        'verb' => [
            ...
            'display' => [
                $lang => 'viewed report choice group'
            ],
        ],
        'object' => utils\get_activity\choicegroup_report($config, $event->contextinstanceid),

...
/**
 * xAPI transformer for mod_oidc user logged in event.
 *
...
namespace src\transformer\events\auth_oidc;
...
function user_loggedin(array $config, \stdClass $event) {
    ...
    return [[
        ...
        'verb' => [
            'id' => 'https://assets.adc.cqu.edu.au/live/xapi/verb/logged-in.json',
            'display' => [
                $lang => 'logged into'
            ],
        ],

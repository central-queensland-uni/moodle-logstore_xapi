...
/**
 * xAPI transformer for mod_spa template questions added event.
 *
...
function template_questions_added(array $config, \stdClass $event) {
    $repo = $config['repo'];
    ...
    return [[
        ...
        'verb' => [
            'id' => 'https://assets.adc.cqu.edu.au/live/xapi/verb/added.json',
            'display' => [
                $lang => 'added'
            ],
        ],

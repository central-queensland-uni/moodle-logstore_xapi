...
/**
 * xAPI transformer for mod_spa submission state updated event.
 *
...
function submission_state_updated(array $config, \stdClass $event) {
    $repo = $config['repo'];
    ...
    return [[
        ...
        'verb' => [
            'id' => 'https://assets.adc.cqu.edu.au/live/xapi/verb/updated.json',
            'display' => [
                $lang => 'updated'
            ],
        ],

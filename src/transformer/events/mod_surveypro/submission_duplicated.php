...
/**
 * xAPI transformer for mod_surveypro submission duplicated event.
 *
...
function submission_duplicated(array $config, \stdClass $event) {
    $repo = $config['repo'];
    ...
    return [[
        ...
        'verb' => [
            'id' => 'https://assets.adc.cqu.edu.au/live/xapi/activitytype/comment.json',
            'display' => [
                $lang => 'commented'
            ],
        ],
